...
<head>
    ...
    <!-- Favicon -->
    <link href="img/fa-icon.ico" rel="icon">
...
<body  >
 ...
 <!-- Spinner Start -->
    ...
    <div class="container-fluid bg-secondary  text-light p-0">
        <div class="row gx-0 d-none d-lg-flex">
            <div class="col-lg-7 px-5 text-start">
                <div class="h-100 d-inline-flex align-items-center me-4">
                    <small class="fa fa-map-marker-alt text-primary me-2"></small>
                    <small>Iconic Corenthum  Tower, Floor no - 7 ,  Office no - 705 A , <br /> Electronic City Metro Station, Noida Sector 62  <br/> </small>
                </div>
                <div class="h-100 d-inline-flex align-items-center">
                    <small class="far fa-clock text-primary me-2"></small>
                    <small>
                Opening Hours : 7 AM to 8 PM (All Days)</small>
                </div>
            </div>
    ...
    <nav class="navbar navbar-expand-lg bg-white navbar-light sticky-top p-0 ">
        <a href="index.php" class="navbar-brand d-flex align-items-center border-end px-4 px-lg-5">
            <div class="mt-[5px]">
        <h2 class="mt-3 text-center mb-0" style="display: flex; align-items: center; justify-content: center; gap: 10px; margin: 0;">
